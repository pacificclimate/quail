...
template_env = Environment(loader=PackageLoader("quail", "templates"), autoescape=True)
...
def get_host():
    ...
    url = url or "http://localhost:5005/wps"
...
@click.option(
    "--port", metavar="PORT", default="5005", help="port in PyWPS configuration."
)
@click.option(
    "--maxsingleinputsize",
    default="200mb",
...
def start(
    ...
    """Start PyWPS service.
    This service is by default available at http://localhost:5005/wps
    """
